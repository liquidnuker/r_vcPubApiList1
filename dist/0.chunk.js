...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_arr_extractUnique_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_arr_extractUnique_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__js_arr_extractUnique_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_arr_sortValue_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_arr_sortValue_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__js_arr_sortValue_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_search_fuse_js__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_search_fuse_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__js_search_fuse_js__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__js_store_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__js_store_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__js_store_js__);
//
//
//
//
...
var vcSearch = function vcSearch() {
  return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 43));
};
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    addFiltersList: function addFiltersList(arr) {
      ...
      // for authTypes
      this.authTypes = Object(__WEBPACK_IMPORTED_MODULE_2__js_arr_extractUnique_js__["arr_extractUnique"])(arr, "Auth");
      this.toggleAuthTypeCheckbox(true);

      // for categoryTypes
      var temp = Object(__WEBPACK_IMPORTED_MODULE_2__js_arr_extractUnique_js__["arr_extractUnique"])(arr, "Category");
      // filter to get length of each item then push
      temp.map(function (i) {
        var l = Object(__WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js__["arr_filter"])(_this2.apiListCache, "Category", i);
    ...
    filterAuthType: function filterAuthType() {
      ...
      if (this.currentCategory !== "All") {
        categoryTemp = Object(__WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js__["arr_filter"])(this.apiListCache, "Category", this.currentCategory);
      } else {
      ...
      this.authTypeSelected.map(function (i) {
        ...
        var t2 = Object(__WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js__["arr_filter"])(categoryTemp, "Auth", i);
      ...
      // HTTPS checkbox
      if (this.https) {
        var hTemp = Object(__WEBPACK_IMPORTED_MODULE_1__js_arr_filter_js__["arr_filter"])(authTemp, "HTTPS", this.https);
    ...
    search: function search() {
      ...
      var res = Object(__WEBPACK_IMPORTED_MODULE_4__js_search_fuse_js__["search_fuse"])({
        data: this.apiListFiltered,
        value: __WEBPACK_IMPORTED_MODULE_6__js_store_js__["store"].fc.searchKeyword,
        searchKeys: ["API", "Link"]
      });
      ...
      if (res.length === 0) {
        ...
        res = null;
        __WEBPACK_IMPORTED_MODULE_6__js_store_js__["store"].fc.searchKeyword = null;
      }
    },
    sort_table: function sort_table(sortBy) {
      this.sortAsc = !this.sortAsc;
      var sorted = Object(__WEBPACK_IMPORTED_MODULE_3__js_arr_sortValue_js__["arr_sortValue"])(sortBy, this.apiListFiltered);
...
var _fuseMin = __webpack_require__(37);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })]), _vm._v("\r\n              Prev\r\n              ")]), _vm._v(" "), _c('p', [_vm._v("Page")]), _vm._v(" "), _c('div', {
  ...
  })])]), _vm._v(" "), _c('p', [_vm._v("Items per page:")]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("\r\n            API\r\n            "), _vm._v(" "), (_vm.sortAsc) ? _c('span', [_c('svg', {
    attrs: {
      "xmlns": "http://www.w3.org/2000/svg",
      "viewBox": "0 0 24 24"
    }
